...
local lang = redis:get(hash)
  ...
  if not lang then
    ...
    return 'ع¯ط±ظˆظ‡ ط¨ظ‡ ظ„غŒط³طھ ع¯ط±ظˆظ‡ ظ‡ط§غŒ ظ…ط¯غŒط±غŒطھغŒ ط±ط¨ط§طھ ط§ط¶ط§ظپظ‡ ظ†ط´ط¯ظ‡ ط§ط³طھ'
   end
  end
  ...
  if next(data[tostring(chat_id)]['banned']) == nil then --fix way
     if not lang then
					...
					return "*ظ‡غŒع† ع©ط§ط±ط¨ط±غŒ ط§ط² ط§غŒظ† ع¯ط±ظˆظ‡ ظ…ط­ط±ظˆظ… ظ†ط´ط¯ظ‡*"
              end
				end
       if not lang then
   message = '*List of banned users :*\n'
         else
   message = '_ظ„غŒط³طھ ع©ط§ط±ط¨ط±ط§ظ† ظ…ط­ط±ظˆظ… ط´ط¯ظ‡ ط§ط² ع¯ط±ظˆظ‡ :_\n'
     end
...
local lang = redis:get(hash)
  ...
  if next(data[tostring(chat_id)]['is_silent_users']) == nil then --fix way
        if not lang then
					...
					return "*ظ„غŒط³طھ ع©ط§ط±ط¨ط±ط§ظ† ط³ط§غŒظ„ظ†طھ ط´ط¯ظ‡ ط®ط§ظ„غŒ ط§ط³طھ*"
             end
				end
      if not lang then
   message = '*List of silent users :*\n'
       else
   message = '_ظ„غŒط³طھ ع©ط§ط±ط¨ط±ط§ظ† ط³ط§غŒظ„ظ†طھ ط´ط¯ظ‡ :_\n'
    end
...
local lang = redis:get(hash)
  ...
  if next(data['gban_users']) == nil then --fix way
    if not lang then
					...
					return "*ظ‡غŒع† ع©ط§ط±ط¨ط±غŒ ط§ط² ع¯ط±ظˆظ‡ ظ‡ط§غŒ ط±ط¨ط§طھ ظ…ط­ط±ظˆظ… ظ†ط´ط¯ظ‡*"
             end
				end
        if not lang then
   message = '*List of globally banned users :*\n'
   else
   message = '_ظ„غŒط³طھ ع©ط§ط±ط¨ط±ط§ظ† ظ…ط­ط±ظˆظ… ط´ط¯ظ‡ ط§ط² ع¯ط±ظˆظ‡ ظ‡ط§غŒ ط±ط¨ط§طھ :_\n'
   end
  ...
  if not data[tostring(msg.chat_id_)]['filterlist'] then
    ...
    save_data(_config.moderation.data, data)
      ...
      if not lang then
       ...
       filterlist = '_ظ„غŒط³طھ ع©ظ„ظ…ط§طھ ظپغŒظ„طھط± ط´ط¯ظ‡ :_\n'
    end
 local i = 1
   for k,v in pairs(data[tostring(msg.chat_id_)]['filterlist']) do
